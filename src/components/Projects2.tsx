...
import CAREER from '../assets/images/sahco-careers.png'
            ...
            <div className='flex flex-col md:flex-row md:items-center text-clayWhite font-poppins' id='work'>
                <div className='md:flex flex-col md:w-1/2'>
                    ...
                    <div className='mt-5 -mb-6 md:mb-0 md:-mr-16 bg-gradient-to-r from-grad7 from-0% via-grad8 via-50% to-grad8 to-70% rounded-xl rounded-b-none md:rounded-xl bg-blend-overlay backdrop-blur-2xl'>
                        <p className='pt-2 pb-3 px-5 font-normal text-xs md:text-sm'>An automated budget submission process for departments in SAHCO, enabling them to upload and send their annual budgets to management for approval. Previously, budgets were manually sent via Excel files, but the new system streamlines this process. <br /><span><b>Tools used: </b>ReactJS</span> </p>
                    </div>
        ...
        <div className='mt-5 md:-mt-10'>
            <div className='flex flex-col-reverse md:flex-row md:items-center text-clayWhite font-poppins' id='work'>
                ...
                <div className='md:flex flex-col md:w-1/2'>
                    ...
                    <h2 className='font-semibold text-xl md:text-3xl text-end'>Assessment App</h2>
                    <div className='mt-5 -mb-6 md:mb-0 md:-ml-16 bg-gradient-to-r from-grad7 from-0% via-grad8 via-50% to-grad8 to-70% rounded-xl rounded-b-none md:rounded-xl bg-blend-overlay backdrop-blur-2xl'>
                        <p className='pt-2 pb-3 px-5 font-normal text-xs md:text-sm'>An online application that enabled job applicants to access the company’s test stages, streamlining the employment process. The system allows administrators to view applicant results and track pass rates, improving effeciency and decision-making. <br /><span><b>Tools used: </b>ReactJS</span> </p>
                    </div>
                    {/* Medium Screens for Links */}
         ...
         <div className='mt-5 md:-mt-10'>
            <div className='flex flex-col md:flex-row md:items-center text-clayWhite font-poppins' id='work'>
                <div className='md:flex flex-col md:w-1/2'>
                    ...
                    <div className='mt-5 -mb-6 md:mb-0 md:-mr-16 bg-gradient-to-r from-grad7 from-0% via-grad8 via-50% to-grad8 to-70% rounded-xl rounded-b-none md:rounded-xl bg-blend-overlay backdrop-blur-2xl'>
                        <p className='pt-2 pb-3 px-5 font-normal text-xs md:text-sm'>A hackathon to show a landing Page with a Contact and Register Page connected to a Backend Api.<br /><span><b>Tools used: </b> ReactJS, Tailwind CSS</span></p>
                    </div>
                    {/* Medium Screens for Links */}
                    <div className='hidden md:flex items-center md:mt-7 md:space-x-5'>
